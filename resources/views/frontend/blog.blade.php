...
<head>
    ...
    <title>Amr | Personal Portfolio</title>
    <link rel="shortcut icon" type="image/ico" href="{{url('frontend/assets/images/favicon.png')}}" />
    ...
    <nav class="navbar navbar-expand-lg main_menu" id="main_menu_area">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="{{url('frontend/assets/images/logo.png')}}" alt="Rabins">
            </a>
                ...
                <div class="row footer-widgets">
                    ...
                    <div class="col-md-4 col-lg-2 offset-lg-1 widget">
                        ...
                        <ul class="nav-menu">
                            ...
                            <li><a href="{{url('/user/portfolio')}}">Portfolio</a></li>

...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{url('assets/css/plugins/summernote-bs4.css')}}">
  <link rel="stylesheet" href="{{url('assets/css/plugins/selectric.css')}}">
  <link rel="stylesheet" href="{{url('assets/css/plugins/bootstrap-tagsinput.css')}}">
...
<body>
       ...
       <!-- Main Content -->
        ...
        <footer class="main-footer">
          <div class="footer-left">
            Copyright &copy;{{date('Y')}} <div class="bullet"></div> Design By <a href="#">ShahbaTech</a>
          </div>
  ...
  <script src="{{url('assets/js/plugins/jquery.selectric.min.js')}}"></script>
  <script src="{{url('assets/js/plugins/jquery.uploadPreview.min.js')}}"></script>
  <script src="{{url('assets/js/plugins/bootstrap-tagsinput.min.js')}}"></script>
